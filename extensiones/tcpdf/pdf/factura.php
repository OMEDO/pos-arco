...
<table>		
    ...
    <td style="; width:140px">        
        <div style="font-size:8.5px; text-align:center; line-height:10px;">
            ...
            <br>
            Dirección: Hidalgo S/N Col. Centro
    ...
    <td style="; width:140px">
        ...
        <div style="font-size:8.5px; text-align:center; line-height:10px;">
            ...
            <br>
            Teléfono: 921-111-63-44
            
            <br>
            ventas@mendozainc.com

        </div>
        
    </td>

    <td style="; width:110px; text-align:center; color:red"><br><br>FACTURA N.<br>$valorVenta</td>
