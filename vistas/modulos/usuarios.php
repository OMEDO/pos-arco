            ...
            <div class="box-body">
                ...
                foreach($usuarios as $key => $value){
                  echo '  <tr>
                            ...
                            <td>'.$value["usuario"].'</td>';
                            if($value["foto"] != ""){
                              echo '<td><img src="'.$value["foto"].'"  class="img-thumbnaul" width="40px"></td>';                                     
                            }else{
                              echo '<td><img src="vistas/img/usuarios/default/anonymous.png"  class="img-thumbnaul" width="40px"></td>';
                            }                  
                            echo '<td>'.$value["perfil"].'</td>';

                            // ACIVAR O DESACTIVAR USUARIO
                            ...
                            // FIN ACTIVAR O DESACTIVAR USUARIO
