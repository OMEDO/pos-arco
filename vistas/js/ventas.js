...
$(".tablaVentas tbody").on("click", "button.agregarProducto", function(){
    ...
    $.ajax({
        ...
        success:function(respuesta){
            ...
            /*==============================
            EVITAR AGREGAR UN PRODUCTO CON STOCK EN CERO                    
            ================================*/
            if(stock == 0){
                swal({
            ...
            $(".nuevoProducto").append(
                ...
                listarProductos()
                // formato al precio de los productos
...
/*==============================
QUITAR PRODUCTOS DE LA VENTA Y RECUPERAR BOTONES                    
================================*/
...
$(".formularioVenta").on("change", "input.nuevaCantidadProducto", function(){
    ...
    if(Number($(this).val()) > Number($(this).attr("stock"))){
        ...
        swal({
            ...
            text: "Existencia en stock: "+$(this).attr("stock")+"  unidades!",
            type: "error",
            confirmButtonText: "¡Cerrar!"
          });
    }
...
$(".formularioVenta").on("change", "input#nuevoValorEfectivo", function(){
	...
	var nuevoCambioEfectivo = $(this).parent().parent().parent().children('#capturarCambioEfectivo').children().children('#nuevoCambioEfectivo');nuevoCambioEfectivo.val(cambio);
